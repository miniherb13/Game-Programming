...
// Stage 3 (emerald / green planet). Cloned from StageGlacier layout.
class StageEmerald {
public:
  ~StageEmerald();
  ...
  // World X for stage-3 decor/platforms; matches Game::kEmeraldStageStartM.
  static constexpr float kWorldOffsetX = 10000.0f;
